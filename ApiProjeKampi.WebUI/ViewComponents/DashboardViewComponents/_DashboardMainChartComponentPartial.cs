...
using ReservationChartDto = ApiProjeKampi.WebUI.Dtos.ReservationDtos.ReservationChartDto;
...
namespace ApiProjeKampi.WebUI.ViewComponents.DashboardViewComponents
{
    public class _DashboardMainChartComponentPartial : ViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            client.BaseAddress = new Uri("https://localhost:7189"); // API adresi burası olacak
