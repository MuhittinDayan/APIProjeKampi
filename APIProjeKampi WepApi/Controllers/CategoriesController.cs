...
namespace APIProjeKampi_WepApi.Controllers
{
    ...
    public class CategoriesController : ControllerBase
    {
        ...
        [HttpPost]
        public IActionResult CreateCategory(CreateCategoryDto creaateCategoryDto)
        {
            //_context.Categories.Add(category);
            //_context.SaveChanges();
            var value = _mapper.Map<Category>(creaateCategoryDto);
        ...
        [HttpPut]
        public IActionResult UpdateCategories(UpdateCategoryDto updateCategoryDto)
        {
