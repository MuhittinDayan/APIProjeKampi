...
namespace APIProjeKampi_WepApi.Controllers
{
    ...
    public class ImagesController : ControllerBase
    {
        ...
        [HttpPost]
        public IActionResult CreateImage(CreateImageDto creaateImageDto)
        {
            var value = _mapper.Map<Image>(creaateImageDto);
        ...
        [HttpPut]
        public IActionResult UpdateImages(UpdateImageDto updateImageDto)
        {
